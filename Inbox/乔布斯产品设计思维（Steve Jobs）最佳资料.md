...
digested: "2026-06-13"
triage: crystallize
sinks: [wiki/product-philosophy]
source_type: "二手（GitHub 提炼笔记/Skill 文件 + 用户整理，非一手原典）"
sources:
  - "https://github.com/alchaincyf/steve-jobs-skill"
  - "https://github.com/K-Dense-AI/mimeographs/tree/main/mimeographs/steve-jobs"
  - "https://book.stevejobsarchive.com/"
---

# 乔布斯产品设计思维（Steve Jobs）— 最佳资料收录

> 主题：乔布斯的产品设计思路与创新精神（心智模型、决策启发式、设计哲学）。
> 一手原典线索：Isaacson《史蒂夫·乔布斯传》、Stanford 2005 演讲、Lost Interview、
> 官方档案 *Make Something Wonderful*（https://book.stevejobsarchive.com/）。
> 本篇收录均为**二手提炼**；引用纪律：出处标「仓库 + 文件」，一手引文需另行核验原始出处。

---

## 第〇部分：资料地图（用户提供的整理，2026-06-13）

### 顶级 GitHub 仓库
1. **alchaincyf/steve-jobs-skill**（强烈推荐）— 基于 Isaacson 传记、Stanford 演讲、Lost Interview 等一手资料提炼的完整思维操作系统：6 个核心心智模型（如「聚焦即说不」）、8 条决策启发式（先做减法、端到端控制、不问用户要什么、现实扭曲力场等）、表达 DNA 和产品审视框架。SKILL.md 详尽，可作 AI Agent 或个人 checklist。
2. **K-Dense-AI/mimeographs**（`mimeographs/steve-jobs/`）— SKILL.md + AGENTS.md，在代码审查、设计决策、PR 中注入工艺精神、用户体验优先、极简主义。
3. 其他：书摘仓库（Nozbe/Michael.team 相关 posts）、tribute pages（UI 灵感，浅）。

### 核心书籍
- 《史蒂夫·乔布斯传》Walter Isaacson（必读，禅宗美学/书法课→极简设计与隐形细节）
- *Insanely Simple*（Ken Segall，「简单」原则）· *Creative Selection*（Ken Kocienda，工程师视角）· *The Innovation Secrets of Steve Jobs*（Carmine Gallo）
- 官方免费档案：**Make Something Wonderful**（演讲、邮件、照片）

### 设计哲学六支柱（Fast Company 等经典总结）
1. **Craftsmanship 工艺至上**：看不见的部分（电路板）也要完美（其父「后院栅栏也要完美」的教导）。
2. **Simplicity 极简**：Design is how it works；去除一切非必需（"1000 songs in your pocket"）。
3. **Focus & Say No**：砍掉 90% 产品线，只专注少数卓越产品。
4. **Empathy & UX**：以人为本；不靠市场调研，而是「展示未来」。
5. **Attention to Detail**：字体、材质、交互的无形之美（书法课影响）。
6. **Integration 端到端控制**：硬件+软件+内容无缝结合。

### 视频/文章
- Stanford 2005 毕业演讲 · WWDC keynotes · D Conference 访谈
- Fast Company: The 6 Pillars of Steve Jobs's Design Philosophy

---

## 第一部分：alchaincyf/steve-jobs-skill · SKILL.md（思维操作系统，全文）

> 原链：https://github.com/alchaincyf/steve-jobs-skill/blob/main/SKILL.md
> 拉取：2026-06-13 · 核验锚："聚焦/说不/现实扭曲" ✓
...
## 第二部分：K-Dense-AI/mimeographs · steve-jobs/SKILL.md（全文）

> 原链：https://github.com/K-Dense-AI/mimeographs/blob/main/mimeographs/steve-jobs/SKILL.md
> 拉取：2026-06-13 · 核验锚："craftsmanship" ✓

---
name: steve-jobs
description: Applies the product philosophy and leadership frameworks of Steve Jobs, co-founder and CEO of Apple Inc. Reach for this skill whenever the user is navigating product design, customer experience, innovation, hiring top-tier talent, or defining corporate culture. Trigger this skill for questions about finding product-market fit, making career trade-offs, building hardware/software ecosystems, or establishing brand values. Use this to push back against feature creep, committee-driven decisions, and technology-first thinking. Apply Jobs's mental models to help users simplify complex systems, focus on craftsmanship, and build products that sit at the intersection of technology and the liberal arts.
---
...
### The "Last Day" Test
*Use when the user is feeling stuck in their career, facing burnout, or evaluating a major life pivot.*
**Steps:** Have the user reflect on their daily routine. Ask them: "If today were the last day of your life, would you want to do what you are about to do today?" If the answer is 'no' for too many days in a row, advise them that a fundamental change is required.

### Customer-Centric Product Vision
*Use when the user is scoping a new product, feature, or startup idea.*
**Steps:** Force the user to stop talking about their tech stack. 1. Identify the incredible benefits they can give to the customer. 2. Determine exactly where they want to take the customer. 3. Only then, work backwards to figure out the technology required to deliver that exact experience.
...
## 第三部分：K-Dense-AI/mimeographs · steve-jobs/AGENTS.md（全文）

> 原链：https://github.com/K-Dense-AI/mimeographs/blob/main/mimeographs/steve-jobs/AGENTS.md
> 拉取：2026-06-13
