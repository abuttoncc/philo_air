...
digested: "2026-06-13"
triage: crystallize
sinks: [wiki/capital-allocation]
author: "Lawrence A. Cunningham, Torkell T. Eide, Patrick Hargreaves"
source_type: "二手（GitHub 读书笔记，非原书全文）"
sources:
  - "https://github.com/ketanarlulkar/Book_Summaries/blob/master/Quality_Investing.md"
---

# Quality Investing（高质量投资）— 最佳笔记收录

> 原书：*Quality Investing: Owning the Best Companies for the Long Term* — Cunningham / Eide / Hargreaves（AKO Capital）
> 本篇收录 GitHub 读书笔记（source_type: 二手），覆盖 Building Blocks（资本配置、资本回报、增长来源、管理层、行业结构）、Competitive Advantage 模式、Pitfalls、Implementation。引用纪律：出处标「笔记作者 + 仓库」，不可冒充原书页码。

> 原链：https://github.com/ketanarlulkar/Book_Summaries/blob/master/Quality_Investing.md
> 拉取：2026-06-13 · 核验锚："capital allocation" ✓
